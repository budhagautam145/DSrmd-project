...
COVID-19 data may be underreported due to limited testing availability or reporting lags.

Daily case and death figures often include delays, especially over weekends or holidays. This can cause dips and spikes in the time series.

The model assumes all states are comparable, but factors such as population age, healthcare infrastructure, urban vs. rural environments, and socioeconomic status can significantly influence outcomes.

The data spans a long period, during which mask mandates, lockdowns, vaccine availability, and public behavior all changed significantly. These time-varying influences are not accounted for in model.
